...
--Question 1: Create product_sales table
...
-- Question 2: Create category table 
...
-- Question 6&7
SELECT 
	AVG(cart_adds/views) AS view_to_add_cvr,
	AVG(purchases/cart_adds) AS add_to_purchase_cvr
FROM product_sales;

-- Part 4: Campaigns Analysis
-- Question 1: Create campaign table
